...
def recog():
    ...
    # print (rects.dtype)
    # print ("Create dict")
    if type(rects).__name__ == 'tuple':
        rects = np.array([],dtype=np.int32)
    # obj = {"frame": frame, "rects": rects}
    # else:
    #     print (rects.tolist())
    #     obj = {"frame": frame.tolist(), "rects": rects.tolist()}
    # print (obj)
    ...
    client.publish("topic/up", rects.tostring())
    print("Sent")
    # res = json.loads(req)
    # print (res)
